...
include '../../classes/OrderListCreator.php';
//include 'includes/class-autoload.inc.php';

$inserter = new OrderListCreator();
?>
...
<div class="createOrder">
    <button type="button" class="start">Utwórz zamówienie</button>
</div>


<form method="POST" action="utworzZamowienie.php">
    <table>
        <tr>
            <th>Nazwa</th>
            <th>Ilość</th>
